...
ifeq ($(cc-name),clang)
KBUILD_CFLAGS	+= -mcpu=cortex-a55+crc+crypto -mtune=cortex-a55 -march=armv8.2-a+crc+crypto+lse+rdm+rcpc+dotprod
KBUILD_AFLAGS	+= -mcpu=cortex-a55+crc+crypto -mtune=cortex-a55 -march=armv8.2-a+crc+crypto+lse+rdm+rcpc+dotprod
endif
endif
